    ...
    public partial class Form1 : Form
    {
        ...
        private void StartMenuButton_Click(object sender, EventArgs e)
        {
            ...
            while (!gameOver)
            {
                ...
                upgradeButton = new();
                caveButton = new();
                ButtonCreator(ref shopButton, "shopButton", StartScreenPictureBox.Width/4, GetNarratorTextBox().Location.Y - 400, 100, 100, "1", ShopButton);
                ButtonCreator(ref upgradeButton, "upgradeButton", StartScreenPictureBox.Width/2 + (StartScreenPictureBox.Width/3), GetNarratorTextBox().Location.Y - 400, 100, 100, "2", UpgradeRoomButton);
                ButtonCreator(ref caveButton, "caveButton", StartScreenPictureBox.Width / 2 + 100, GetNarratorTextBox().Location.Y -400, 100, 100, "3", DisableButton);
                shopButton.Hide();
