...
namespace Food_Crawler
{
    public partial class Form1
    {
        ...
        public void Room2()
        {
            ...
            ButtonCreator(ref armorButton, "armorButtonForm", StartScreenPictureBox.Width/2 - 50, healthButton.Location.Y + 50, 70, 70, "AMR", ArmorButtonFunc);
            ButtonCreator(ref damageButton, "damageButtonForm", StartScreenPictureBox.Width / 8, StartScreenPictureBox.Height/2 + (StartScreenPictureBox.Height/8), 70, 70, "DMG", DamageButtonFunc);
            ButtonCreator(ref speedButton, "speedButtonForm", StartScreenPictureBox.Width / 2 + (StartScreenPictureBox.Width/4) + 30, healthButton.Location.Y, 70, 70, "SPD", speedButtonFunc);
        ...
        {//since we need to pass in the enemey and player we will decide how to generate a enemey here
            ...
            PictureBoxCreator(ref enemeyPictureBox, 300, 300, this.StartScreenPictureBox.Width / 2, this.Height /3, EnemeyImage);;
            ...
            PictureBoxCreator(ref enemeyWeaponPictureBox, 100, 100, enemeyPictureBox.Location.X, enemeyPictureBox.Location.Y + enemeyPictureBox.Height/2, EnemeyWeaponImage);
        ...
        public void EnemeyStatsLabelUpdater(ref Enemey enemey)
        {
            ...
            //this is probably overkill but im not trying to figure out why label.Location.X = some number does not work thats not very fortnite
            LabelCreator(ref enemeyhealthLabel, "enemeyhealthLabelForm", enemeyPictureBox.Location.X - 150, enemeyPictureBox.Location.Y - 60, 50, 50, $"HP: {enemey.GetHealth()}", Color.Red);
